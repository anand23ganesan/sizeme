	...
	function registerEvent(){
		...
		$(document).on('click',".go-back-second",function(){
			...
			if (paper_type_val_show == "1" || paper_type_val_show == "0") {
				$("#fms-user-ins-page1 .fms-instruction-img").attr("src", "https://shoesizefinder.bata.in/assets/img/single-paper-grab-1.png");
			} else {
		...
		$(document).on('click',".go-back-second-left",function(){
			...
			var paper_type_val_show = fms.getPaperType( $( ".fms-SizeSystem" ).val(), "ROW", $( ".fms-shoesize" ).val() );
			if (paper_type_val_show == "1" || paper_type_val_show == "0") {
				$( "#fms-user-ins-left-page1 .fms-instruction-img" ).attr( "src", "https://shoesizefinder.bata.in/assets/img/single-paper-grab-1.png" );
			} else {
		...
		$( document ).on( "click", ".fms-take-photo-btn", function(){
			...
			//$( ".fms-video-frame" ).attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-right.png" );
			...
			if(this.isSinglePaper){
				...
				if(customepaperT == 4){
					$( ".fms-video-frame" ).attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-right-double.png" );
				}
				if(customepaperT == 3){
					$( ".fms-video-frame" ).attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-right-double.png" );
				}
        ...
        $( document ).on( "click", ".fms-view-left-btn", function(){
			...
			if(this.isSinglePaper){
				$( ".fms-video-frame" ).removeClass('fms-double-frame-video');
				if(customepaperT == 1){
					$( ".fms-video-frame" ).attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-left.png" );
				}
				if(customepaperT == 0){
					$( ".fms-video-frame" ).attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-left.png" );
				}
				...
				$( ".fms-video-frame" ).addClass('fms-double-frame-video');
				if(customepaperT == 4){
					$( ".fms-video-frame" ).attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-left-double.png" );
				}
				if(customepaperT == 3){
					$( ".fms-video-frame" ).attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-left-double.png" );
				}
		...
		$( document ).on( "click", ".fms-take-photo-btn-left", function(){
			...
			//$( ".fms-video-frame" ).attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-left.png" );
			//$(".left_photograph").attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-left.png");
			var geoValue = (typeof ($("input[name=Geography]:checked").val()) != "undefined") ? $("input[name=Geography]:checked").val() : $("input[name=Geography]").val();
			var geoValue = 'ROW';
		...
		//social logout for bata 	
		$( document ).on( 'click', '.fms-social-bata-logout', function(){	
			if( log_in_provider != null ){	
				if( log_in_provider == "fb" ){	
					FB.logout(function(response) {	
						window.location.reload();	
...
var findmeashow = function(){
				...
				//right foot
					...
					if (self.isSinglePaper) {
						...
						if(customepaperT == 1){
							...
							self.rightFrame.attr("src", "https://shoesizefinder.bata.in/assets/img/outline-right.png");
						}
						if(customepaperT == 0){
							self.rightFrame.attr("src", "https://shoesizefinder.bata.in/assets/img/outline-right.png");
						}
						...
						if(customepaperT == 4){
							...
							self.rightFrame.attr("src", "https://shoesizefinder.bata.in/assets/img/outline-right-double.png");
						}
						if(customepaperT == 3){
							self.rightFrame.attr("src", "https://shoesizefinder.bata.in/assets/img/outline-right-double.png");
						}
					...
					if (self.isSinglePaper) {
						...
						if(customepaperT == 1){
							...
							self.rightFrame.attr("src", "https://shoesizefinder.bata.in/assets/img/outline-right-grey.png");
						}
						if(customepaperT == 0){
							self.rightFrame.attr("src", "https://shoesizefinder.bata.in/assets/img/outline-right-grey.png");
						}
						...
						if(customepaperT == 4){
							...
							self.rightFrame.attr("src", "https://shoesizefinder.bata.in/assets/img/outline-right-double-grey.png");
						}
						if(customepaperT == 3){
							self.rightFrame.attr("src", "https://shoesizefinder.bata.in/assets/img/outline-right-double-grey.png");
						}
						  ...
						  $('.fms-video-frame').removeClass('fms-double-frame-video');
							...
							if($( "[name=foot_type]" ).val() == 1){
								if(customepaperT == 1){
									...
									self.rightFrame.attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-left.png" );
								}
								if(customepaperT == 0){
									self.rightFrame.attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-left.png" );
								}
							...
							if($( "[name=foot_type]" ).val() == 1){
								if(customepaperT == 4){
									...
									self.rightFrame.attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-left-double.png" );
								}
								if(customepaperT == 3){
									self.rightFrame.attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-left-double.png" );
								}
						...
						if( self.isSinglePaper ){
							...
							if($( "[name=foot_type]" ).val() == 1){
								if(customepaperT == 1){
									...
									self.rightFrame.attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-left-grey.png" );
								}
								if(customepaperT == 0){
									self.rightFrame.attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-left-grey.png" );
								}
						   ...
						   $('.fms-video-frame').addClass('fms-double-frame-video');
							...
							if($( "[name=foot_type]" ).val() == 1){
								if(customepaperT == 4){
									//Geo location Us for the double paper left grey
									self.rightFrame.attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-left-double-grey.png" );
								}
								if(customepaperT == 3){
									self.rightFrame.attr( "src", "https://shoesizefinder.bata.in/assets/img/outline-left-double-grey.png" );
								}
	...
	this.sendData = function () {
		...
		// console.log('image_form',formData);
		setTimeout(function () {
		...
		if (this.isSinglePaper) {
			...
			if($( "[name=foot_type]" ).val() == 0){	
				if(paperT == 4){
					...
					this.rightFrame.attr("src", "https://shoesizefinder.bata.in/assets/img/outline-right-double.png");
				}
				if(paperT == 3){
					this.rightFrame.attr("src", "https://shoesizefinder.bata.in/assets/img/outline-right-double.png");
				}	
				...
				if(paperT == 4){	
					...
					this.rightFrame.attr("src", "https://shoesizefinder.bata.in/assets/img/outline-left-double.png");		
				}	
				if(paperT == 3){		
					this.rightFrame.attr("src", "https://shoesizefinder.bata.in/assets/img/outline-left-double.png");		
				}		
	...
	this.showInstruction_2 = function (_type, geoValue) {
		...
		if (_type == "1" || _type == "0") {
			$(".fms-instruction-img").attr("src", "https://shoesizefinder.bata.in/assets/img/singlepaper_image_jun.png");
			$(".fms-instruction-list-first").show();
			$(".fms-instruction-list-sec").hide();
			$("#paper_count").text('one');
			$("#paper_count_s").text('paper');
		} else {
			$(".fms-instruction-img").attr("src", "https://shoesizefinder.bata.in/assets/img/doublepaper_image_jun.png");
	...
	this.showInstruction_left_2 = function( _type,geoValue ){
		...
		if( _type == "1" || _type == "0" ){
			$( ".fms-instruction-img" ).attr( "src","https://shoesizefinder.bata.in/assets/img/singlepaper_image_left_jun.png" );
			$( ".fms-instruction-list-first" ).show();
			$( ".fms-instruction-list-sec" ).hide();
			$( "#paper_count_left" ).text('one');
			$( "#paper_count_s_left" ).text('paper');
		} else {
			$( ".fms-instruction-img" ).attr( "src", "https://shoesizefinder.bata.in/assets/img/doublepaper_image_left_jun.png" );
			$( ".fms-instruction-list-first" ).hide();
			$( ".fms-instruction-list-sec" ).show();
	...
	this.showResult = function( _obj, _err ){
       ...
       // _err = true;
		if( _err ){
			...
			// $( ".fms-result-error .fms-error-img img" ).attr( "src", "https://shoesizefinder.bata.in/assets/img/error_code/" + _obj.err_img + ".png" );
			...
			if( _obj.status == "success" ){
                ...
                console.log('gender_left',_obj.data.left.gender);
  				...
  				console.log('_obj',_obj);
                console.log('sat',_obj.data.other_details.status);
				if( _obj.data.other_details.status == "success" ){
                	...
                	//right
                	if( typeof _obj.data.other_details.data.right != "undefined" ){
                		if( typeof _obj.data.other_details.data.right.paper_type != "undefined" ){
                			var _obj_paper_type_val = _obj.data.other_details.data.right.paper_type;
                			$("#right_paper_type").val(_obj_paper_type_val);
                			$("#left_paper_type").val(_obj_paper_type_val);
                			if(_obj_paper_type_val >= 3) {
                				$('#shoesize_yes').prop('checked',true);
                				$('#shoesize_yes1').prop('checked',true);
                			} else {
                				$('#shoesize_no').prop('checked',true);
                				$('#shoesize_no1').prop('checked',true);
                			}
                		}
                		if( typeof _obj.data.other_details.data.right.age != "undefined" ){
                			// $("#right_paper_type").val(_obj.data.other_details.data.right.age);
                			age_text_right = _obj.data.other_details.data.right.age + " years old ";
                			age_text_left = _obj.data.other_details.data.right.age + " years old ";
                			$('.selected-form-age').val(_obj.data.other_details.data.right.age);
                		}
                	}
                	//left
                	// if( typeof _obj.data.other_details.data.left != "undefined" ){
                	// 	if( typeof _obj.data.other_details.data.left.paper_type != "undefined" ){
                	// 		$("#left_paper_type").val(_obj.data.other_details.data.left.paper_type);
                	// 	}
                	// 	if( typeof _obj.data.other_details.data.left.age != "undefined" ){
                	// 		// $("#left_paper_type").val(_obj.data.other_details.data.left.age);
				...
				if($( "[name=foot_type]" ).val() == 0){
					...
					$(".fms-bata-size-text").html('Bata size:');
					var other_paw = $("#other_paw_right").val();
					...
					// ****bata style ends
					$(".foot-report-image").attr('src','https://shoesizefinder.bata.in/assets/img/Rightfoot_Wiremesh.png');
				} else {
					...
					$(".foot-report-image").attr('src','https://shoesizefinder.bata.in/assets/img/Leftfoot_Wiremesh.png');
	...
	this.fmsLogin = function (_data) {
		...
		//var _data = {'name' : 'Findmeashoe', 'email': signin_email, 'login_provider' : 'google'};
		log_in_provider = _data.login_provider;
		$("#user_email_custom").val(_data.email);
		self.ajax.ping("set_user_login", {
			fms_is_loged_in: true,
			login_email: _data.email,
			login_name: _data.email,
		...
		fms.noteUserF('<i class="fa fa-cog fa-spin fa-3x fa-fw"></i> Give us moment, we are retrieving your data...', "active");
		$(".fms-first-and-last-name").val(_data.name);
		$(".fms-user-email").val(_data.email);
		$(".camera-user-name").text(_data.name);
		// $("#data-section").addClass("init-active");
		var user_type = $("#user_type").val();
		if(user_type == 'new_user'){
 ...
 //        return PaperType;
	...
	this.getPaperType = function (SizeSystem, Geo, Size) {
		...
		console.log('get_paper',PaperType);
