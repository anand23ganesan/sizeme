...
<html lang="en" dir="ltr">
    <head>
        ...
        <title>Bata Shoesize</title>
         ...
         <meta name="google-signin-client_id" content="206194684427-vtb0fvuufb9c95f765apt1k621gkdlam.apps.googleusercontent.com">
         <script src="https://apis.google.com/js/platform.js" async defer></script>
         <link rel="stylesheet" type="text/css"  href="assets/css/jquery-confirm.css"/>
         <script src="assets/js/jquery-confirm.js"></script>
          <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD0JsyItHkuqxP2q0BjWnwtUBZbB8Ek5DI&callback=init"></script>
        ...
        <script type="text/javascript">
           $(document).ready(function(){
             ...
             if (isIOSChrome) {
//               window.location.href = "https://shoesizefinder.bata.in/not-safari.php";
             } 
             //Only For IOS
...
/*           .custom-img-div , .custom-text-div{    
   ...
   <body>
     ...
     <input type="hidden" name="geo_location_state" class="geo_location_state" >
      ...
      <input type="hidden" name="user_email_custom" id="user_email_custom" value="">
      ...
      <input type="hidden" name="form-systemsize" id="form-systemsize" value="<?php echo $systemsize; ?>">
        ...
        <div class="wrapper custom-home-wrapper">
           ...
           <div class="fms-section-container">
            <?php 
              ...
              <!-- User login section  social-logins -->
              <section id="social-logins" class="do_not_show" >
                <div class="container">
                     <div class="bata-home">
                         <h1>Hi, Guest</h1>
                         <p>We know that your shoe size is different for different shoe types and styles.</p>
                     </div>
                     <div class="home-img-area">
                         <img src="assets/images/home-shoe.jpg" alt="shoe" class="img-fluid">
                     </div>
                     <div class="red-info">
                         <p>Introducing Bata <br> Shoe Size Finder Application </p>
                     </div>
                     <div class="gray-area">
                         <p>Measure your foot size virtually for every shoe type and get personalized recommendations.</p>
                     </div>
                     <div class="loginNow-area">
                         <h4>Login Now to find your perfect size</h4>


                         <!-- Social login buttons -->
                          <button class="social-gmail-btn social-login-btn g-signin2" data-onsuccess="googleOnSignIn">
                            <img src="assets/images/signin-google.png" alt="signin-google" class="img-fluid">
                          </button>

                        <!--   <button class="social-login-btn fb-login-button" data-size="large" data-button-type="login_with" data-auto-logout-link="false" onlogin="fms.fbcheckLoginState();" data-use-continue-as="false"> 
                            <img src="assets/images/signin-fb.png" alt="signin-fb" class="img-fluid"> 
                          </button> -->
                            <div class="fb-login-button" data-size="large" data-button-type="login_with" data-auto-logout-link="false" onlogin="fms.fbcheckLoginState();" data-use-continue-as="false">Sign in with Facebook</div>
                         <!-- Social login ends -->

                          <!-- ******For entering email in input starts****-->
                          <!-- <div class="fms-login-buttons">
                              <div>
                                 <input class="signin_textbox" type="email" name="signin_email" id="signin_email" placeholder="Enter valid email for login" />
                              </div>
                              <div>
                                 <label for="" id="signupEmailError" class="custom-email-error"></label>
                              </div>
                              <button class="custom-red-btn-login" onclick="fms.fmsLogin();"><img src="assets/images/check-circle.png" alt="icon">Login</button>
                          </div> -->
                          <!-- ******For entering email in input starts ends****-->
              ...
              <section id="data-section" class="do_not_show" style="display: none;">
                  <div class="container">
                     ...
                     <div class="perfect-form-area">
                      <form id="sent_to_api" action="request.php" method="post">
                        ...
                        <label><input type="hidden" name="fms-first-and-last-name" placeholder="First & Second Name" class="fms-first-and-last-name" value="Guest"></label>
                        <label><input type="hidden" name="user_email" placeholder="email" class="fms-user-email" value=""></label>
                        ...
                        <div class="typical-shoe" style="display: none;">
                          ...
                          <div class="form-check form-check-inline us-div">
                            <!-- <input class="form-check-input fms-geoloc" type="radio" name="Geography" value="US" id="us_geography"> -->
                            <label class="form-check-label" for="us_geography">US</label>
                          </div>
                          <div class="form-check form-check-inline rest-of-world-div">
                            <input class="form-check-input fms-geoloc" type="radio" name="Geography"  value="ROW" id="row_geography" checked>
                            <label class="form-check-label" for="row_geography">Rest of the world</label>
                          </div>
                        </div>
                        ...
                        <div class="form-group form-check-inline form-age">
                          <label for="inputState">Age</label>
                           <select class="form-control col-9 selected-form-age">
                          <?php 
                            for ($i=4; $i < 100; $i++) { 
                          ?>
                              <?php if($i == 25){
                        ...
                        <!-- Age selects ends -->
                        <label class="hide"><span>User Name</span><input name="username" placeholder="" value=""></label>
                        ...
                        <!--<label class="hide"><span>Foot type</span><input name="foot_type" placeholder="" value="0"></label>-->
                        <label class="hide"><span>Org Id</span><input name="orgID" placeholder="" value="37"></label>
                        <label class="hide"><span>Image Data</span><input name="topView" placeholder="" value=""></label>
                        <label class="hide"><span>Curl Url</span><input name="requestUrl" placeholder="" value="<?php echo $weblink; ?>request.php"></label>
                        <!-- for new api's -->
                        ...
                        <!-- <label class="hide"><span>SizeSystem</span><input type="hidden" name="SizeSystem" class="fms-SizeSystem request-systemsize" value="US"></label>
                        ...
                        <div class="form-check-inline form-age form-age-scale" style="width:100% !important;">
                          ...
                          <select  name="size" class="fms-shoesize shoesize form-control col-6">
                          </select> -->
                          ...
                          <!-- <select name="confirm-shoesize" class=" confirm-shoesize form-control col-6">
                     ...
                     <div class="sigle-line-btn">
                        ...
                        <button class="fms-take-instruction check-back red-btn"><img src="assets/images/check-circle.png" alt="icon"> Submit</button>
                        <button class="fms-take-reset red-btn" onclick="resetForm();"><img src="assets/images/left-circle-icon.png" />Reset</button>
                        <button class="red-btn fms-social-bata-logout"><img src="assets/images/cross-icon.png" alt="icon">Logout</button>
                     </div>
                     <div><p>By using the shoe size finder you agree to our <a href="https://www.bata.in/bataindia/sc-177_cat-41/privacy-policy.html">terms & conditions</a></p></div>
                  </div>
               </section>
                ...
                <section  id="user-confirmation-section" style="display:none;" class="user-confirmation">
                  <div class="container">
                     ...
                     <div class="sigle-line-btn confirmation-buttons">
                        <!-- <button type="submit" class="red-btn"><img src="images/left-circle-icon.png" alt="icon"> Go back</button> -->
                        <button class="red-btn confirm-buttons submit-confirm"><img src="assets/images/check-circle.png" alt="icon"> Submit</button>
                        <button class="red-btn confirm-buttons reset-confirm"><img src="assets/images/left-circle-icon.png" />Cancel</button>
                     </div>
                  </div>
                </section>
               ...
               <section id="fms-user-instruction" class="do_not_show" style="display: none;">
                   ...
                   <div class="two-red-btn">
                       <div class="row">
                         <div class="col-6">
                           ...
                           <button type="button" class="red-btn back-btn-confirm hide-retake-back-butn"><img src="assets/images/left-circle-icon.png" alt="icon" class="btn-icon"> Go Back</button>
                         ...
                         <div class="col-6">
                           <button type="button" class="red-btn fms-take-ins-next"><img src="assets/images/left-circle-icon.png" alt="icon" class="btn-icon flip-icon"> Next</button>
                         </div>
                         <div class="col-12">
                ...
                <div id="fms-user-ins-page2" class="container" style="display:none;">
                   ...
                   <div class="two-red-btn">
                       <div class="row">
                         <div class="col-6">
                           <button type="button" class="red-btn go-back-second"><img src="assets/images/left-circle-icon.png" alt="icon" class="btn-icon"> Go Back</button>
                         </div>
                         <div class="col-6">
                           <button type="button" class="red-btn fms_second_next"><img src="assets/images/left-circle-icon.png" alt="icon" class="btn-icon flip-icon"> Next</button>
                         </div>
                       </div>
                   </div>
                </div>
                <div id="fms-user-ins-page3" class="container" style="display:none;">
                 ...
                 <div class="two-red-btn">
                     <div class="row">
                       <div class="col-6 p-2">
                         <button type="button" class="red-btn go-back-third"><img src="assets/images/left-circle-icon.png" alt="icon" class="btn-icon"> Go Back</button>
                       </div>
                       <div class="col-6 p-2">
                         <button type="button" class="red-btn pd-left-30 fms-take-photo-btn"><img src="assets/images/camera-icon.png" alt="icon" class="camera-icon"> Take Picture</button>
                       </div>
                     </div>
                 </div>
                </div>
               ...
               <section id="fms-user-instruction-left" class="do_not_show" style="display: none;">
                <div id="fms-user-ins-left-page1" class="container">
                   ...
                   <div class="two-red-btn">
                       <div class="row">
                         <div class="col-6">
                           <!-- <button type="button" class="red-btn back-btn-confirm"><img src="assets/images/left-circle-icon.png" alt="icon" class="btn-icon"> Go Back</button> -->
                         ...
                         <div class="col-6">
                           <button type="button" class="red-btn fms-take-ins-next-left"><img src="assets/images/left-circle-icon.png" alt="icon" class="btn-icon flip-icon"> Next</button>
                         </div>
                       </div>
                   </div>
                </div>
                <div id="fms-user-ins-left-page2" class="container" style="display:none;">
                   ...
                   <div class="two-red-btn">
                       <div class="row">
                         <div class="col-6">
                           <button type="button" class="red-btn go-back-second-left"><img src="assets/images/left-circle-icon.png" alt="icon" class="btn-icon"> Go Back</button>
                         </div>
                         <div class="col-6">
                           <button type="button" class="red-btn fms_second_next_left"><img src="assets/images/left-circle-icon.png" alt="icon" class="btn-icon flip-icon"> Next</button>
                         </div>
                       </div>
                   </div>
                </div>
                <div id="fms-user-ins-left-page3" class="container" style="display:none;">
                 ...
                 <div class="two-red-btn">
                     <div class="row">
                       <div class="col-6 p-2">
                         <button type="button" class="red-btn go-back-third-left"><img src="assets/images/left-circle-icon.png" alt="icon" class="btn-icon"> Go Back</button>
                       </div>
                       <div class="col-6 p-2">
                         <button type="button" class="red-btn pd-left-30 fms-take-photo-btn-left"><img src="assets/images/camera-icon.png" alt="icon" class="camera-icon"> Take Picture</button>
                       </div>
                     </div>
                 </div>
                </div>
              ...
              <section id="camera-section" class="do_not_show height-media" style="display: none;">
                 <div class="video-with-frame-container">
                    <div class="customer-logo">
                      <p class="camera-screen-text">Make sure your foot is within the outline.</p>
                      <a class="back-button-camera" href="javascript:void(0);"> < Back</a>
                    ...
                    <div class="fms-camera-icon">
                        <img src="https://shoesizefinder.bata.in/assets/img/camera.png" class="">
                 ...
                 <div class="fms-review-image" id="scroll_image_div" style="">
                    <!-- <img id="img_elem" src="" class="image-preview-im img-fluid"> -->
                    <img id="img_elem" src="" class="image-preview-im">
                 ...
                 <div class="fms-bottom-button-container camera_buttons two-red-btn">
                      <div class="row">
                        <div class="col-6">         
                          ...
                          <button data-ftype="l" class="start-left-foot red-btn"><img src="assets/images/retake-icon.png" alt="icon" class="camera-icon"> Retake</button>
                        </div>
                        <div class="col-6">
                ...
                <section id="fms-result" class="do_not_show" style="display: none;">
                  <div class="container fms-result-wrapper">
                      <div class="foot-profile pd-t15 mb-4">
                         <h2>Here’s the foot profile <br> for your: <span class="fms-foot-type"> Right Foot </span></h2>
                      ...
                      <div class="foot-profile-img fms-result-container">
                        ...
                        <div class="feet-profile-img">
                         ...
                         <button class="red-btn update-warning-btn" style="display:none;">Update required</button>
                        </div>
                      </div>
                      ...
                      <div class="retake-btns-area">
                          <div class="row">
                              <div class="col-12 p-1" id="fms-right-result-btns">
                                  <button data-ftype="r" class="button-half-width retake-btn fms-retake-photo">Retake right foot</button>
                                  <button data-ftype="l" class="button-half-width retake-btn float-right fms-left-photo">Take left foot</button>
                                  <button data-ftype="r" class="button-half-width retake-btn float-right fms-view-left-btn">View left foot</button>
                              </div>
                              <div class="col-12 p-1" id="fms-left-result-btns">
                                  <button data-ftype="r" class="button-half-width retake-btn fms-view-right-btn">View right foot</button>
                                  <button data-ftype="l" class="button-half-width retake-btn float-right fms-retake-left-photo">Retake Left foot</button>
                                  <button data-ftype="l" class="button-half-width retake-btn float-right start-left-foot">Start left foot</button>
                              </div>
                          </div>
                      </div>
                      <div class="sigle-line-btn three-foot-report-button">
                        ...
                        <!-- <button href="javascript:void(0);" class="red-btn bata-close-application"><img src="assets/images/cross-icon.png" alt="icon"> Close this Application</button> -->
                         <button href="javascript:void(0);" class="red-btn bata-close-application"><img src="assets/images/cross-icon.png" alt="icon"> Go to bata.in</button>
                         <button class="red-btn fms-social-bata-logout"><img src="assets/images/cross-icon.png" alt="icon">Logout</button>
                      </div>
                   </div>
              ...
              <section id="fms-oriandation" style="display: none;">
                  <div class="motion-sensor-enable container" id="ios">
                    ...
                    <div class="sigle-line-btn">
                      <button type="button" class="red-btn fms-take-photo-btn"><img src="assets/images/check-circle.png" alt="icon"> Done</button>
                    </div>
                 </div>
              </section>
              ...
              <section id="fms-camera-enable-flow" style="display: none;">
                 <div class="fms-camera-enable-flow container">
                    ...
                    <div class="fms-bottom-button-container sigle-line-btn">
                       <button class="red-btn fms-take-photo-btn"><img src="assets/images/check-circle.png" alt="icon">Done</button>
                    </div>
                 </div>
              </section>
              ...
              <section id="data-section-updated" class="do_not_show" style="display: none;">
                 <div class="container">
                     ...
                     <div class="fms-bottom-button-container sigle-line-btn">
                       <button class="red-btn fms-take-instruction-updated  check-back" data-type="new_user"><img src="assets/images/check-circle.png" alt="icon">Submit</button>
                       <button class="red-btn fms-take-reset" onclick="resetForm();"><img src="assets/images/left-circle-icon.png" />Reset</button>
                     </div>
                  </div>
              </section>
...
<?php else: ?>
<?php
//   echo "<script> document.location.href='https://shoesize.online/dev/bata-9-social/desktop.php';</script>";
   ...
   <body>
      <div class="fms-desktop-welcome-page">
         ...
         <p>Please open this link on a mobile browser to get started with the picture taking process. <br>
            ...
            <br><br>
            Open on mobile browser: <a href="https://shoesizefinder.bata.in/"><?php echo $_SERVER['HTTP_HOST']; ?></a>
         </p>
         <br><br>
         <br><br>
